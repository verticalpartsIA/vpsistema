...
import {
  ...
  Clock, LogIn, LogOut, Monitor, UserPlus, Shield,
  ClipboardList, Activity as ActivityIcon, ChevronDown, RefreshCw
} from 'lucide-react'
...
export default function CeoDashboard({ onBack }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      {/* Abas */}
      <div className="bg-surface-card border-b border-surface-border px-6">
        <div className="max-w-7xl mx-auto flex gap-1">
          {[
            { key: 'visao-geral',    label: 'Visão Geral',      icon: BarChart2 },
            { key: 'linha-do-tempo', label: 'Linha do Tempo',   icon: Clock },
